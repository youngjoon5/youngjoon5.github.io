...
\begin{tabular}{rl}
    ...
    \textsc{Homepage:}   & \href{https://sites.google.com/site/youngjoon5}{https://sites.google.com/site/youngjoon5}\\
...
\textbf{Research Interest}: Resilience, Diffusion, Network, Agent-based model, and Complex Adaptive Systems\\
%\vspace{-3pt}

\begin{tabular}{rl}
& (Under review) Modeling for vulnerable infrastructure
systems \\
